...
class Player(GravityEntity):
    ...
    def __init__(self):
        super().__init__(Point2D(0, 128), 10, True, 0.3, AnimatedSprite('player_idle.png', Point2D(32, 44), 3, speed=0.25))
    ...
    def animate(self):
        if self.animation_state == self.PlayerStates.RUNNING and self._sprite.path != 'sprites/player_running.png':
